...
EdgeR_Func = function(Counts, G1, G2, xi, test_type, treatment_groupings_same = FALSE, comparison_order = 'Simple') {
...
for(xi in 1:7) {
  ...
  G1 = c_obj_str(DRA_C)
  G2 = c_obj_str(DRA_T)
  EdgeR_Func(Counts, G1, G2, xi, 'bonferroni', comparison_order='Simple')
  EdgeR_Func(Counts, G1, G2, xi, 'fdr', comparison_order='Simple')
  ...
  G1 = c_obj_str(DRA_T)
  G2 = c_obj_str(LIB_T)
  EdgeR_Func(Counts, G1, G2, xi, 'bonferroni', treatment_groupings_same = TRUE, comparison_order='Complex')
  EdgeR_Func(Counts, G1, G2, xi, 'fdr', treatment_groupings_same = TRUE, comparison_order='Complex')
}
```